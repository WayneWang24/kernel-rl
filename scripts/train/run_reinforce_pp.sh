...
# REINFORCE++ RL 训练脚本
#
# 从 SFT checkpoint 开始，使用 REINFORCE++ 算法
# 硬件：2× A100 80GB
#
# 用法：
#   bash scripts/train/run_reinforce_pp.sh [额外 override 参数]
# ============================================================
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=reinforce_pp_qwen25_coder_7b \
    trainer.default_local_dir="${PROJECT_DIR}/checkpoints/reinforce_pp" \
